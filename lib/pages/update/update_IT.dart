...
class UpdateITScreen extends StatefulWidget {
  const UpdateITScreen({super.key});

  @override
  _UpdateITScreenState createState() => _UpdateITScreenState();
}

class _UpdateITScreenState extends State<UpdateITScreen> {
  ...
  late final VoidCallback onSearch;
