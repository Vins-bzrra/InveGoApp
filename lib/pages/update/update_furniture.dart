...
class UpdateFurnitureScreen extends StatefulWidget {
  const UpdateFurnitureScreen({super.key});

  @override
  _UpdateFurnitureScreenState createState() => _UpdateFurnitureScreenState();
}

class _UpdateFurnitureScreenState extends State<UpdateFurnitureScreen> {
  ...
  Future<void> _updateItemDetails() async {
    ...
    try {
      final http.Response response = await http.post(
        Uri.parse(Urls.UpdateFurniture.value),
        headers: <String, String>{
          'Content-Type': 'application/json',
          'Authorization': 'Bearer $token',
        },
