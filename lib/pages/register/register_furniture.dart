...
class RegisterFurnitureScreen extends StatefulWidget {
  const RegisterFurnitureScreen({super.key});

  @override
  _RegisterFurnitureScreenState createState() => _RegisterFurnitureScreenState();
}

class _RegisterFurnitureScreenState extends State<RegisterFurnitureScreen> {
  ...
  Future<void> _registerItems(BuildContext context) async {
    ...
    try {
      final http.Response response = await http.post(
        Uri.parse(Urls.RegisterFurniture.value),
