...
class RegisterITScreen extends StatefulWidget {
  const RegisterITScreen({super.key});

  @override
  _RegisterITScreenState createState() => _RegisterITScreenState();
}

class _RegisterITScreenState extends State<RegisterITScreen> {
  ...
  Future<void> _registerItems(BuildContext context) async {
    ...
    try {
      final http.Response response = await http.post(
        Uri.parse(Urls.RegisterIT.value),
