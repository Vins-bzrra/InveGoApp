...
class DisposedFurnitureScreen extends StatefulWidget {
  const DisposedFurnitureScreen({super.key});

  @override
  _DisposedITScreenState createState() => _DisposedITScreenState();
}

class _DisposedITScreenState extends State<DisposedFurnitureScreen> {
  ...
  Future<void> _disposeItem() async {
    ...
    try {
      final http.Response response = await http.put(
        Uri.parse(Urls.DisposedFurniture.value),
        headers: <String, String>{
