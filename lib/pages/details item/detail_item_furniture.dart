...
class ItemFurnitureDetailsScreen extends StatefulWidget {
  final int itemId;

  const ItemFurnitureDetailsScreen({Key? key, required this.itemId}) : super(key: key);

  @override
  _ItemFurnitureDetailsScreenState createState() => _ItemFurnitureDetailsScreenState();
}

class _ItemFurnitureDetailsScreenState extends State<ItemFurnitureDetailsScreen> {
  ...
  Future<void> _getItemDetails() async {
    ...
    try {
      final http.Response response = await http.get(
        Uri.parse('${Urls.ItemFurnitureDetails.value}/${widget.itemId}'),
