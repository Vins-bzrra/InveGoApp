...
class ItemITDetailsScreen extends StatefulWidget {
  final int itemId;

  const ItemITDetailsScreen({Key? key, required this.itemId}) : super(key: key);

  @override
  _ItemITDetailsScreenState createState() => _ItemITDetailsScreenState();
}

class _ItemITDetailsScreenState extends State<ItemITDetailsScreen> {
  ...
  Future<void> _getItemDetails() async {
    ...
    try {
      final http.Response response = await http.get(
        Uri.parse('${Urls.ItemITDetails.value}/${widget.itemId}'),
