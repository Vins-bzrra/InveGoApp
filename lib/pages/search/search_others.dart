...
class SearchOthersScreen extends StatelessWidget {
  ...
  SearchOthersScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Pesquisar Outros Itens'),
      ),
  ...
  Future<void> _searchItem(BuildContext context) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        showBottomSheetSearch(context, itens, "Others");
